...
<template>
        <section class="relative overflow-hidden bg-white lg:px-8">
            ...
            >
                <img
                    src="https://res.cloudinary.com/iraklitbz/image/upload/v1712411150/hero_fcfc6daef4_nqwzzp.svg"
                    alt="decoration svg"
                    class="absolute inset-0 w-full h-full"
                />
                <div class="relative flex flex-col items-center justify-center">
                <h1
                    class="text-5xl font-semibold text-center font-display text-slate-900 sm:text-6xl"
                >
                    Como te podemos
                    ...
                    <svg
                        ...
                        viewBox="0 0 249 22"
                        fill="currentColor"
                        class="absolute top-2/3 left-0 h-[0.6em] w-full scale-110 fill-sky-200/75"
                    >
                        <path
                    ...
                    <span class="relative">ayudar ?</span>
                    </span>
                </h1>
                <p
                    class="max-w-xl mx-auto mt-6 text-lg leading-8 text-center text-slate-700"
                >
                    Contactanos y mediante este formulario y te responderemos lo antes posible. Gracias por tu interés.
                </p>
                    ...
                    <div class="relative w-full max-w-lg mt-12">
                        ...
                        <svg
                            ...
                            viewBox="0 0 91 49"
                            fill="none"
                            class="relative left-0 w-20 h-auto -top-5 text-slate-600"
                        >
